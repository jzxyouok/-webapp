...
class Smarty_Internal_Utility {
     ...
     *
     * @param Smarty $smarty  Smarty instance to IndexImg
    ...
    public static function testInstall(Smarty $smarty, &$errors=null)
    {
        ...
        if ($errors === null) {
            echo "<PRE>\n";
            echo "Smarty Installation IndexImg...\n";
            echo "Testing template directory...\n";
        }

        // IndexImg if all registered template_dir are accessible
        ...
        // IndexImg if registered compile_dir is accessible
        ...
        // IndexImg if all registered plugins_dir are accessible
        ...
        // IndexImg if all registered cache_dir is accessible
        ...
        // IndexImg if all registered config_dir are accessible
        ...
        // IndexImg if sysplugins are available
        ...
        // IndexImg if core plugins are available
